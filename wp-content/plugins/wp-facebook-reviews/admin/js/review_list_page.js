(function( $ ) {
	...
	$(function(){
		...
		$( "#wpfbr_removeallbtn" ).click(function() {
		  openpopup(adminjs_script_vars.popuptitle2, '<p>'+adminjs_script_vars.popupbody2+'</p>', '<a class="button dashicons-before dashicons-no" href="?page=wp_fb-reviews&opt=delallfb" style="margin-bottom: 5px;">'+adminjs_script_vars.popupbody3+'</a> <a class="button dashicons-before dashicons-no" href="?page=wp_fb-reviews&opt=delalltw" style="margin-bottom: 5px;">'+adminjs_script_vars.popupbody4+'</a> <a class="button dashicons-before dashicons-no" href="?page=wp_fb-reviews&opt=delall" style="margin-bottom: 5px;">'+adminjs_script_vars.popupbody5+'</a>');
		});	
