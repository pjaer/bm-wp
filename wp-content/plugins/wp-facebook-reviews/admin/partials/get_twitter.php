...
<div id="apikeyformdiv" class="<?php echo $keyformhideshow; ?> wprevpro_margin10 bordered_form" id="login_cookie">
	    <form  action="?page=wp_fb-get_twitter" method="post" name="logincookie" enctype="multipart/form-data">
		<table class="">
		<tbody>
			<tr class="wprevpro_row">
				<td scope="row" style="width:50%;">
				<div class="twitter_key_header"><?php _e('Consumer API Keys:', 'wp-fb-reviews'); ?></div>
				<div class="twitter_key_div"><?php _e('API Key:', 'wp-fb-reviews'); ?> <input class="inputrow100per" type="text" name="wprevpro_twitter_api_key" id="wprevpro_twitter_api_key" value="<?php echo get_option('wprevfb_twitterapi_key'); ?>"></div>
				<div class="twitter_key_div"><?php _e('API Secret Key:', 'wp-fb-reviews'); ?> <input class="inputrow100per" type="text" name="wprevpro_twitter_api_key_secret" id="wprevpro_twitter_api_key_secret" value="<?php echo get_option('wprevfb_twitterapi_key_secret'); ?>"></div>
				</td>
				...
				<div class="twitter_key_div"><?php _e('Access Token:', 'wp-fb-reviews'); ?> <input class="inputrow100per" type="text" name="wprevpro_twitter_api_token" id="wprevpro_twitter_api_token" value="<?php echo get_option('wprevfb_twitterapi_token'); ?>"></div>
				<div class="twitter_key_div"><?php _e('Access Token Secret:', 'wp-fb-reviews'); ?> <input class="inputrow100per" type="text" name="wprevpro_twitter_api_token_secret" id="wprevpro_twitter_api_token_secret" value="<?php echo get_option('wprevfb_twitterapi_token_secret'); ?>"></div>
				</td>
			</tr>
			<tr class="wprevpro_row">
...
<form name="newtemplateform" id="newtemplateform" action="?page=wp_fb-get_twitter" method="post">
...
echo $dbmsg;
	...
	$urltrimmed = remove_query_arg( array('taction', 'id') );
		...
		$html .= '<tr id="'.$currentform->id.'">
				...
				<th scope="col" class="manage-column" limage="'.$currentform->profile_img.'" fcats="'.$fcategories.'" fposts="'.$fposts.'" ftitle="'.$currentform->title.'" epoint="'.$currentform->endpoint.'" squery="'.$currentform->query.'"><a href="'.$url_tempeditbtn.'" class="rfbtn button button-secondary dashicons-before dashicons-admin-generic">'.__('Edit', 'wp-fb-reviews').'</a> <a href="'.$url_tempdelbtn.'" class="rfbtn button button-secondary dashicons-before dashicons-trash">'.__('Delete', 'wp-fb-reviews').'</a> <a href="'.$url_tempcopybtn.'" class="rfbtn button button-secondary dashicons-before dashicons-admin-page">'.__('Copy', 'wp-fb-reviews').'</a> <span class="rfbtn button button-primary dashicons-before dashicons-star-filled retreviewsbtn"> '.__('Get Tweets', 'wp-fb-reviews').'</span></th>
			</tr>';
	}
	} else {
