...
class WP_FB_Reviews_Admin {
		  ...
		  <p><b>- Download a CSV File:</b> Save a CSV file to your computer containing all the reviews in this table.</p> ', 'wp-fb-reviews'),
			...
			if($_GET['page']=="wp_fb-templates_posts"){
				...
				wp_localize_script('templates_posts_page-js', 'adminjs_script_vars', 
					...
					'popupbody3' => esc_html__('Enter this shortcode on a post or page:', 'wp-fb-reviews'),
	...
	public function add_menu_pages() {
		...
		$submenu_title = __('Reviews List', 'wp-fb-reviews');
	...
	public function wprev_add_external_link_admin_submenu() {
		...
		$menu_slug = 'wp_fb-welcome'; // used as "key" in menus
		...
		$submenu[$menu_slug][] = array('<div id="wprev-66021">Go Pro!</div>', 'manage_options', 'https://ljapps.com/wp-review-slider-pro/');
	}
